...
(function() {
  ...
  function updateWhatsAppUrl() {
    ...
    var rawText = "Merhaba, Kilit & Kapı Donanımı kataloğunuzdan '" + currentProduct.name + "' (" + selectedSize + ") ürünü için Balçova/Urla stok durumu ve fiyat bilgisi almak istiyorum.";
  ...
  function closeModal() {
    ...
    if (window.history && window.history.replaceState) {
      window.history.replaceState({}, "", "/kilit-kapi-hirdavat.html");
    }
  }
  ...
  function checkDeepLink() {
    ...
    if (targetId) {
      var p = KILIT_PRODUCTS_DATA.find(function(it) { return it.id === targetId; });
      if (p) {
